...
description: "Use this skill for any task related to running, starting, or growing a Catering Services business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: C
---
...
> Use this skill for any task related to running, starting, or growing a **Catering Services** business.
...
Event and corporate catering services.
...
|------|---------|
| **Type** | Food & Beverage |
| **Revenue Model** | Per-event contracts, monthly tiffin |
| **Key Costs** | Food materials, staff, equipment |
| **Typical Team Size** | 5–30 |
| **Licenses Needed** | FSSAI, GST |
| **Primary Tools** | Petpooja, WhatsApp, Google Sheets |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Petpooja as primary tool
