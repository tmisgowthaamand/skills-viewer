...
description: "Use this skill for any task related to running, starting, or growing a Web Development business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: W
---
...
> Use this skill for any task related to running, starting, or growing a **Web Development** business.
...
| **Revenue Model** | Project fees, retainer (hosting/maintenance) |
| **Key Costs** | Staff, tools, cloud hosting |
| **Typical Team Size** | 3–20 |
| **Licenses Needed** | GST |
| **Primary Tools** | WordPress, React, GitHub, AWS, Figma, Jira |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up WordPress as primary tool
