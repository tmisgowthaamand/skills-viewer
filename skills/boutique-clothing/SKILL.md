...
description: "Use this skill for any task related to running, starting, or growing a Boutique (Clothing) business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: B
---
...
> Use this skill for any task related to running, starting, or growing a **Boutique (Clothing)** business.
...
Fashion boutique selling curated clothing and accessories.
...
|------|---------|
| **Type** | Fashion Retail |
| **Revenue Model** | Product sales, custom orders |
| **Key Costs** | Inventory, rent, staff |
| **Typical Team Size** | 2–10 |
| **Licenses Needed** | GST, Shop & Est. |
| **Primary Tools** | Shopify, Instagram Shopping, Vyapar |
