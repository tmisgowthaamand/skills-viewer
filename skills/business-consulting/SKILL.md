...
description: "Use this skill for any task related to running, starting, or growing a Business Consulting business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: B
---
...
> Use this skill for any task related to running, starting, or growing a **Business Consulting** business.
...
Management and strategy consulting for businesses.
...
| **Revenue Model** | Retainer, project, success fees |
| **Key Costs** | Staff, travel, tools |
| **Typical Team Size** | 2–20 |
| **Licenses Needed** | GST, Company reg |
| **Primary Tools** | PowerPoint, Excel, Miro, HubSpot |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up PowerPoint as primary tool
