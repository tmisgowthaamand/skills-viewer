---
name: yoga-studio
description: "Use this skill for any task related to running, starting, or growing a Yoga Studio business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: Y
---
...
> Use this skill for any task related to running, starting, or growing a **Yoga Studio** business.
...
|------|---------|
| **Type** | Wellness |
| **Revenue Model** | Membership, drop-in, online classes |
| **Key Costs** | Rent, instructor staff, equipment |
| **Typical Team Size** | 2–10 |
| **Licenses Needed** | Yoga certification, GST |
| **Primary Tools** | Mindbody, Glofox, Zoom, Instagram |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Mindbody as primary tool
