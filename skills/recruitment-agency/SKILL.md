...
description: "Use this skill for any task related to running, starting, or growing a Recruitment Agency business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: R
---
...
> Use this skill for any task related to running, starting, or growing a **Recruitment Agency** business.
...
| **Revenue Model** | Placement fees (8–15% of annual CTC) |
| **Key Costs** | Staff, job portal subscriptions |
| **Typical Team Size** | 3–20 |
| **Licenses Needed** | GST |
| **Primary Tools** | Naukri, LinkedIn Recruiter, Zoho Recruit |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Naukri as primary tool
