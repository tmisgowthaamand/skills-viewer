---
name: graphic-design
description: "Use this skill for any task related to running, starting, or growing a Graphic Design Studio business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: G
---

# 🖌️ Graphic Design Studio

> Use this skill for any task related to running, starting, or growing a **Graphic Design Studio** business.
...
Logo, brand, and print design studio.
...
| **Key Costs** | Staff, software |
| **Typical Team Size** | 2–10 |
| **Licenses Needed** | GST |
| **Primary Tools** | Adobe Illustrator, Photoshop, Figma |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Adobe Illustrator as primary tool
