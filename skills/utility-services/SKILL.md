...
description: "Use this skill for any task related to running, starting, or growing a Utility Services business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: U
---
...
> Use this skill for any task related to running, starting, or growing a **Utility Services** business.
...
Plumbing, electrical, HVAC, and facility services.
...
|------|---------|
| **Type** | Services |
| **Revenue Model** | AMC contracts, per-job fees |
| **Key Costs** | Technical staff, equipment, transport |
| **Typical Team Size** | 5–30 |
| **Licenses Needed** | GST, trade certifications |
| **Primary Tools** | FieldCircle, ServiceMax, Tally, WhatsApp |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up FieldCircle as primary tool
