...
description: "Use this skill for any task related to running, starting, or growing a Cleaning Services business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: C
---
...
> Use this skill for any task related to running, starting, or growing a **Cleaning Services** business.
...
|------|---------|
| **Type** | Services |
| **Revenue Model** | Per-job, monthly contracts |
| **Key Costs** | Staff, cleaning supplies |
| **Typical Team Size** | 3–20 |
| **Licenses Needed** | GST, Shop & Est. |
| **Primary Tools** | UrbanCompany, WhatsApp, Google Sheets |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up UrbanCompany as primary tool
