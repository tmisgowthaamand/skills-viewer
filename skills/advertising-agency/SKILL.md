...
description: "Use this skill for any task related to running, starting, or growing a Advertising Agency business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: A
---
...
> Use this skill for any task related to running, starting, or growing a **Advertising Agency** business.
...
Creative and media agency for brand campaigns, digital ads, and media buying.
...
| **Revenue Model** | Retainer + project fees |
| **Key Costs** | Staff, media production |
| **Typical Team Size** | 5–30 |
| **Licenses Needed** | GST, Company reg |
| **Primary Tools** | Adobe Suite, Meta Ads, Google Ads |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Adobe Suite as primary tool
