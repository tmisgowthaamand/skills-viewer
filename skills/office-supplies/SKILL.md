...
description: "Use this skill for any task related to running, starting, or growing a Office Supplies Store business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: O
---

# 🖊️ Office Supplies Store

> Use this skill for any task related to running, starting, or growing a **Office Supplies Store** business.
...
Office stationery and supplies for businesses.
...
|------|---------|
| **Type** | B2B Retail |
| **Revenue Model** | Corporate account sales |
| **Key Costs** | Inventory, delivery fleet |
| **Typical Team Size** | 3–15 |
| **Licenses Needed** | GST, Shop & Est. |
| **Primary Tools** | Tally, WhatsApp Business, IndiaMART |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Tally as primary tool
