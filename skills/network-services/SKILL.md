...
description: "Use this skill for any task related to running, starting, or growing a Network Services business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: N
---
...
> Use this skill for any task related to running, starting, or growing a **Network Services** business.
...
| **Revenue Model** | AMC contracts, project fees |
| **Key Costs** | Equipment, staff |
| **Typical Team Size** | 3–20 |
| **Licenses Needed** | GST |
| **Primary Tools** | Cisco/Mikrotik, PRTG, SolarWinds, Tally |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Cisco/Mikrotik as primary tool
