...
description: "Use this skill for any task related to running, starting, or growing a Construction Company business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: C
---
...
> Use this skill for any task related to running, starting, or growing a **Construction Company** business.
...
|------|---------|
| **Type** | Construction |
| **Revenue Model** | Project contracts |
| **Key Costs** | Materials, labour, equipment |
| **Typical Team Size** | 10–100 |
| **Licenses Needed** | RERA, PWD contractor licence, GST |
| **Primary Tools** | AutoCAD, MS Project, Procore, Tally |
