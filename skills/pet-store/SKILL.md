---
name: pet-store
description: "Use this skill for any task related to running, starting, or growing a Pet Store & Pet Care business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: P
---
...
> Use this skill for any task related to running, starting, or growing a **Pet Store & Pet Care** business.
...
Pet supplies, grooming, and care services.
...
| **Revenue Model** | Product sales, grooming, pet boarding |
| **Key Costs** | Inventory, rent, staff, animal care |
| **Typical Team Size** | 2–10 |
| **Licenses Needed** | Shop & Est., GST |
| **Primary Tools** | POS, Instagram, WhatsApp |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up POS as primary tool
