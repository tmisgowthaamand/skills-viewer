...
description: "Use this skill for any task related to running, starting, or growing a Social Media Marketing business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: S
---
...
> Use this skill for any task related to running, starting, or growing a **Social Media Marketing** business.
...
| **Revenue Model** | Monthly retainer per client |
| **Key Costs** | Staff, tools, content production |
| **Typical Team Size** | 3–20 |
| **Licenses Needed** | GST |
| **Primary Tools** | Meta Business Suite, Canva, Hootsuite, Later |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up Meta Business Suite as primary tool
