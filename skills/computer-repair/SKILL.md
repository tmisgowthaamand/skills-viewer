...
description: "Use this skill for any task related to running, starting, or growing a Computer Repair business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: C
---
...
> Use this skill for any task related to running, starting, or growing a **Computer Repair** business.
...
Computer, laptop, and IT hardware repair.
...
|------|---------|
| **Type** | Tech Services |
| **Revenue Model** | Per-repair, AMC contracts |
| **Key Costs** | Parts, tools, rent |
| **Typical Team Size** | 2–8 |
| **Licenses Needed** | GST, Shop & Est. |
| **Primary Tools** | ServiceCRM, Tally, WhatsApp |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up ServiceCRM as primary tool
