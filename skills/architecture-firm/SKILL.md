...
description: "Use this skill for any task related to running, starting, or growing a Architecture Firm business. Covers business planning, finance, marketing, operations, and compliance."
version: 1.0.0
category: business
letter: A
---
...
> Use this skill for any task related to running, starting, or growing a **Architecture Firm** business.
...
Architectural design, planning, and supervision.
...
| **Revenue Model** | Design fees (% of project) |
| **Key Costs** | Staff, software, site visits |
| **Typical Team Size** | 3–20 |
| **Licenses Needed** | CoA (Council of Architecture) registration |
| **Primary Tools** | AutoCAD, Revit, SketchUp, Lumion |

## Quick Start Checklist

- [ ] Register business (GST + local licences)
- [ ] Set up AutoCAD as primary tool
